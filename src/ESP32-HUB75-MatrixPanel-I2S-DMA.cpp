...
void MatrixPanel_I2S_DMA::fillTriangleDMA(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
...
void MatrixPanel_I2S_DMA::fillCircleDMA(int16_t x0, int16_t y0, int16_t rad, uint8_t r, uint8_t g, uint8_t b) {
  vlineDMA(x0, y0 - rad, 2 * rad + 1, r, g, b);
  fillCircleHelperDMA(x0, y0, rad, 3, 0, r, g, b);
}

void MatrixPanel_I2S_DMA::fillCircleHelperDMA(int16_t x0, int16_t y0, int16_t rad, uint8_t corners, int16_t delta, uint8_t r, uint8_t g, uint8_t b) {
  int16_t f = 1 - rad;
  int16_t ddF_x = 1;
  int16_t ddF_y = -2 * rad;
  int16_t x = 0;
